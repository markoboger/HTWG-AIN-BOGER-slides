...
- **HTML-Version** (empfohlen): Öffnen Sie die `.html`-Datei im Browser.  
  - **F** → Vollbild  
  - Pfeiltasten / Leertaste → navigieren  
  - **P** → Presenter-View (Notizen + nächste Folie)

- **PDF-Version**: Gut geeignet zum Ausdrucken oder Offline-Nutzung.

- Die Folien werden bei jedem Push auf `main` automatisch aktualisiert.
...
**Ihr Name**  
Professor / Dozent für Informatik  
HTWG Konstanz

Bei Fragen oder Fehlern einfach eine Issue im Repository öffnen oder per E-Mail melden.
